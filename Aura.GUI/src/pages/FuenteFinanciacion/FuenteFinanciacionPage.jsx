...
import './FuenteFinanciacionPage.css'; 
import FuenteFinanciacionDialogo from './FuenteFinanciacionDialogo.jsx';

const API_BASE_URL = import.meta.env.VITE_API_URL;
const ENDPOINT = `${API_BASE_URL}/admin/fuente-financiacion`;

const FuenteFinanciacionPage = () => {
  ...
  const fetchDatos = async () => {
    try {
      ...
      console.error("Error cargando fuentes de financiación:", error);
    } finally {
      setCargando(false);
    }
  };
  ...
  const handleGuardar = async (datosFormulario) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        alert(error.mensaje || "Error al procesar la fuente");
      }
    } catch (error) {
  ...
  return (
    <div className="admin-page-container">
      <header className="admin-page-header">
        <div>
          <h2 className="admin-title">Fuentes de Financiación</h2>
...
export default FuenteFinanciacionPage;
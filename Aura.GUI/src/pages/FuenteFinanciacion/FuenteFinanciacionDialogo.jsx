...
import './FuenteFinanciacionDialogo.css'; 

const FuenteFinanciacionDialogo = ({ isOpen, onClose, onGuardar, dataParaEditar }) => {
    ...
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal-content" onClick={(e) => e.stopPropagation()}>
        <div className="modal-header">
          <div>
             <h3>{dataParaEditar ? 'Editar Fuente de Financiación' : 'Nueva Fuente de Financiación'}</h3>
             <p className="modal-subtitle-top">Configuración de origen de recursos</p>
          </div>
...
export default FuenteFinanciacionDialogo;
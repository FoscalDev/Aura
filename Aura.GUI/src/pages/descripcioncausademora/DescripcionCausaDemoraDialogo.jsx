...
import './DescripcionCausaDemoraDialogo.css'; 

const DescripcionCausaDemoraDialogo = ({ isOpen, onClose, onGuardar, dataParaEditar }) => {
    ...
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal-content" onClick={(e) => e.stopPropagation()}>
        <div className="modal-header">
          <div>
             <h3>{dataParaEditar ? 'Editar Detalle de Demora' : 'Nueva Descripción de Demora'}</h3>
             <p className="modal-subtitle-top">Especificación técnica de causas</p>
          </div>
...
export default DescripcionCausaDemoraDialogo;
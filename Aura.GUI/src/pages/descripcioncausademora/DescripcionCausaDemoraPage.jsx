...
import './DescripcionCausaDemoraPage.css'; 
import DescripcionCausaDemoraDialogo from './DescripcionCausaDemoraDialogo.jsx';

const API_BASE_URL = import.meta.env.VITE_API_URL;
const ENDPOINT = `${API_BASE_URL}/admin/descripcion-causa-demora`;

const DescripcionCausaDemoraPage = () => {
  ...
  const fetchDatos = async () => {
    try {
      ...
      console.error("Error cargando descripciones de causas:", error);
    } finally {
      setCargando(false);
    }
  };
  ...
  const handleToggleEstado = async (id) => {
    ...
    try {
      ...
      console.error("Error al cambiar estado de la descripción:", error);
    }
  };
  ...
  return (
    <div className="admin-page-container">
      <header className="admin-page-header">
        <div>
          <h2 className="admin-title">Descripción Causas Demora</h2>
...
export default DescripcionCausaDemoraPage;
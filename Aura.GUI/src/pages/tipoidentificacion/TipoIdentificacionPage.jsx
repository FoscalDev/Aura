...
import './TipoIdentificacionPage.css'; 
import TipoIdentificacionDialogo from './TipoIdentificacionDialogo.jsx';

const API_BASE_URL = import.meta.env.VITE_API_URL;
const ENDPOINT = `${API_BASE_URL}/admin/tipo-identificacion`;

const TipoIdentificacionPage = () => {
  ...
  return (
    <div className="admin-page-container">
      <header className="admin-page-header">
        <div>
          <h2 className="admin-title">Tipos de Identificación</h2>
          <p className="admin-subtitle">Configuración Maestra FOSCAL</p>
        </div>
              ...
              {lista.map((item) => (
                <tr key={item._id}>
                  ...
                  <td className="actions-cell text-center">
                    <button className="action-btn edit" onClick={() => { setEditando(item); setIsModalOpen(true); }}>
                      ✏️
                    </button>
                  </td>
                </tr>

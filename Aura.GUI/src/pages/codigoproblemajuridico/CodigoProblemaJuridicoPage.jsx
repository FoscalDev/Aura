...
import './CodigoProblemaJuridicoPage.css'; 
import CodigoProblemaJuridicoDialogo from './CodigoProblemaJuridicoDialogo.jsx';

const API_BASE_URL = import.meta.env.VITE_API_URL;
const ENDPOINT = `${API_BASE_URL}/admin/codigo-problema-juridico`;

const CodigoProblemaJuridicoPage = () => {
  ...
  return (
    <div className="admin-page-container">
      <header className="admin-page-header">
        <div>
          <h2 className="admin-title">Código Problema Jurídico</h2>
...
export default CodigoProblemaJuridicoPage;
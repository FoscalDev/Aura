...
import './CodigoProblemaJuridicoDialogo.css'; 

const CodigoProblemaJuridicoDialogo = ({ isOpen, onClose, onGuardar, dataParaEditar }) => {
    ...
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal-content" onClick={(e) => e.stopPropagation()}>
        <div className="modal-header">
          <div>
             <h3>{dataParaEditar ? 'Editar Problema Jurídico' : 'Nuevo Problema Jurídico'}</h3>
             <p className="modal-subtitle-top">Definición de tipos de procesos</p>
          </div>
...
export default CodigoProblemaJuridicoDialogo;
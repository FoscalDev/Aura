...
import './EtniaPage.css'; 
import EtniaDialogo from './EtniaDialogo.jsx';

const API_BASE_URL = import.meta.env.VITE_API_URL;
const ENDPOINT = `${API_BASE_URL}/admin/etnia`;
...
const EtniaPage = () => {
  ...
  const fetchDatos = async () => {
    try {
      ...
      console.error("Error cargando etnias:", error);
    } finally {
      setCargando(false);
    }
  };
  ...
  return (
    <div className="admin-page-container">
      <header className="admin-page-header">
        <div>
          <h2 className="admin-title">Maestro de Etnias</h2>

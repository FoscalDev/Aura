...
import './RegimenAfiliacionDialogo.css'; 

const RegimenAfiliacionDialogo = ({ isOpen, onClose, onGuardar, dataParaEditar }) => {
    ...
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal-content" onClick={(e) => e.stopPropagation()}>
        <div className="modal-header">
          <div>
             <h3>{dataParaEditar ? 'Editar Régimen' : 'Nuevo Régimen de Afiliación'}</h3>
             <p className="modal-subtitle-top">Configuración del tipo de afiliación </p>
          </div>
...
export default RegimenAfiliacionDialogo;
...
import './CausaDemoraDialogo.css'; 

const CausaDemoraDialogo = ({ isOpen, onClose, onGuardar, dataParaEditar }) => {
    ...
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal-content" onClick={(e) => e.stopPropagation()}>
        <div className="modal-header">
          <div>
             <h3>{dataParaEditar ? 'Editar Causa de Demora' : 'Nueva Causa de Demora'}</h3>
             <p className="modal-subtitle-top">Gestión de tiempos y retrasos</p>
          </div>
...
export default CausaDemoraDialogo;
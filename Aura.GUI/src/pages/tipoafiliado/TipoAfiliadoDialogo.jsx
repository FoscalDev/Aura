...
import './TipoAfiliadoDialogo.css'; 

const TipoAfiliadoDialogo = ({ isOpen, onClose, onGuardar, dataParaEditar }) => {
    ...
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal-content" onClick={(e) => e.stopPropagation()}>
        <div className="modal-header">
          <div>
             <h3>{dataParaEditar ? 'Editar Tipo Afiliado' : 'Nuevo Tipo Afiliado'}</h3>
             <p className="modal-subtitle-top">Complete los campos requeridos</p>
          </div>
        ...
        <form onSubmit={handleSubmit} className="modal-form">
          ...
          <div className="input-group">
            <label>Nombre de Afiliación</label>
            <input 
              name="nombre" 
...
export default TipoAfiliadoDialogo;
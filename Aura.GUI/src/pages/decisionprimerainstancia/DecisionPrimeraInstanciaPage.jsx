...
import './DecisionPrimeraInstanciaPage.css'; 
import DecisionPrimeraInstanciaDialogo from './DecisionPrimeraInstanciaDialogo.jsx';

const API_BASE_URL = import.meta.env.VITE_API_URL;
const ENDPOINT = `${API_BASE_URL}/admin/decision-primera-instancia`;

const DecisionPrimeraInstanciaPage = () => {
  ...
  return (
    <div className="admin-page-container">
      <header className="admin-page-header">
        <div>
          <h2 className="admin-title">Decisión Primera Instancia</h2>
      ...
      <DecisionPrimeraInstanciaDialogo 
...
export default DecisionPrimeraInstanciaPage;
...
import OrganizacionDialogo from './OrganizacionDialogo.jsx';

const API_BASE_URL = import.meta.env.VITE_API_URL;
const ENDPOINT = `${API_BASE_URL}/admin/organizacion`;
  ...
  return (
    <div className="admin-page-container">
      <header className="admin-page-header">
        <div>
          <h2 className="admin-title">Organizaciones</h2>
            ...
            <tbody>
              {lista.map((item) => (
                <tr key={item._id}>
                  ...
                  <td>{item.tipoIdentificacion}: {item.numeroIdentificacion}</td>

...
import './PretensionTutelaDialogo.css'; 

const PretensionTutelaDialogo = ({ isOpen, onClose, onGuardar, dataParaEditar }) => {
    ...
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal-content" onClick={(e) => e.stopPropagation()}>
        <div className="modal-header">
          <div>
             <h3>{dataParaEditar ? 'Editar Pretensión' : 'Nueva Pretensión de Tutela'}</h3>
             <p className="modal-subtitle-top">Definición de solicitudes legales</p>
          </div>
...
export default PretensionTutelaDialogo;
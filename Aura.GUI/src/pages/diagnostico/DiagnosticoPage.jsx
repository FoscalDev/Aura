...
import DiagnosticoDialogo from './DiagnosticoDialogo.jsx';

const API_BASE_URL = import.meta.env.VITE_API_URL;
const ENDPOINT = `${API_BASE_URL}/admin/diagnostico`;
...
const DiagnosticoPage = () => {
  ...
  const handleToggleEstado = async (id) => {
    ...
    try {
      ...
      console.error("Error al cambiar estado del diagnóstico:", error);
    }
  };
  ...
  const handleGuardar = async (datosFormulario) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        alert(error.mensaje || "Error al procesar el diagnóstico");
      }
    } catch (error) {
  ...
  return (
    <div className="admin-page-container">
      <header className="admin-page-header">
        <div>
          <h2 className="admin-title">Maestro de Diagnósticos</h2>

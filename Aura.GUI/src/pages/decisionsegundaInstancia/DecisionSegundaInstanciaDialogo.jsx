...
import './DecisionSegundaInstanciaDialogo.css'; 

const DecisionSegundaInstanciaDialogo = ({ isOpen, onClose, onGuardar, dataParaEditar }) => {
    ...
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal-content" onClick={(e) => e.stopPropagation()}>
        <div className="modal-header">
          <div>
             <h3>{dataParaEditar ? 'Editar Decisión 2da Instancia' : 'Nueva Decisión Segunda Instancia'}</h3>
             <p className="modal-subtitle-top">Parámetros de respuesta jerárquica</p>
          </div>
...
export default DecisionSegundaInstanciaDialogo;
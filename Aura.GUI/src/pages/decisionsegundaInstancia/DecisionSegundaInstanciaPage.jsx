...
import './DecisionSegundaInstanciaPage.css'; 
import DecisionSegundaInstanciaDialogo from './DecisionSegundaInstanciaDialogo.jsx';

const API_BASE_URL = import.meta.env.VITE_API_URL;
const ENDPOINT = `${API_BASE_URL}/admin/decision-segunda-instancia`;

const DecisionSegundaInstanciaPage = () => {
  ...
  const fetchDatos = async () => {
    try {
      ...
      console.error("Error cargando decisiones de segunda instancia:", error);
    } finally {
      setCargando(false);
    }
  };
  ...
  return (
    <div className="admin-page-container">
      <header className="admin-page-header">
        <div>
          <h2 className="admin-title">Decisión Segunda Instancia</h2>
      ...
      <DecisionSegundaInstanciaDialogo 
...
export default DecisionSegundaInstanciaPage;
...
import './MigrantePage.css'; 
import MigranteDialogo from './MigranteDialogo.jsx';

const API_BASE_URL = import.meta.env.VITE_API_URL;
const ENDPOINT = `${API_BASE_URL}/admin/migrante`;
...
const MigrantePage = () => {
  ...
  const fetchDatos = async () => {
    try {
      ...
      console.error("Error cargando lista de migrantes:", error);
    } finally {
      setCargando(false);
    }
  };
  ...
  const handleToggleEstado = async (id) => {
    ...
    try {
      ...
      console.error("Error al cambiar estado del migrante:", error);
    }
  };
  ...
  return (
    <div className="admin-page-container">
      <header className="admin-page-header">
        <div>
          <h2 className="admin-title">Migrantes</h2>

...
import './MigranteDialogo.css'; 

const MigranteDialogo = ({ isOpen, onClose, onGuardar, dataParaEditar }) => {
    ...
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal-content" onClick={(e) => e.stopPropagation()}>
        <div className="modal-header">
          <div>
             <h3>{dataParaEditar ? 'Editar Migrante' : 'Nuevo Registro de Migrante'}</h3>
             <p className="modal-subtitle-top">Categorización de población migrante</p>
          </div>
...
export default MigranteDialogo;